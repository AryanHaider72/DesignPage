"use client";
import LoginOfflineSeller from "@/api/lib/OfflineSeller/MainPage/OfflineSellerLogin/OfflineSellerLogin";
import LoginApiOnline from "@/api/lib/OnlineSeller/LoginOnlineSeller/LoginOnlineSeller";
import { Lock, Mail } from "lucide-react";
import { useState } from "react";

export default function PosSellerLogin() {
  ...
  const login = async () => {
    try {
      ...
      const response = await LoginApiOnline(formData);
      ...
      if (response.success) {
        ...
        console.log(data);
        localStorage.setItem("wareHouseSellerToken", data?.token);
        window.location.href = "/WareHouseSeller/MainPage/Dashboard";
        setLoading(false);
        return;
      }
    } finally {
