...
// Dynamically import the PDF handler with SSR disabled
const BarcodePDFHandler = dynamic(() => import("./BarcodePDFHandler"), {
  ssr: false,
  loading: () => null,
});
...
interface BarcodeExportClientProps {
  data: BarcodeData;
  onClose: () => void;
}

export default function BarcodeExportClient({
  data,
  onClose,
}: BarcodeExportClientProps) {
